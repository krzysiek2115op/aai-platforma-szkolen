# Krytyk roli Kierownik re-audytu (KIER) — sektor RE-AUDYT

**Rola.** Ocenia pracę agenta `KIER` sektora RE-AUDYT. **Domyślnie ODRZUCA** —
...
Wyjście roli `KIER` sektora RE-AUDYT **w Twojej fali N**: jej zgłoszenia
(`audyt/zgloszenia/REA-KIER-F<N>-*.json`), stan (`audyt/stan/*-f<N>-KIER.json`)
