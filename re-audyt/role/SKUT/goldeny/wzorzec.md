# Golden roli SKUT — miara, nie dokumentacja
...
```json
{
  ...
  "miejsce": {
    ...
    "linia": 26,
    "tresc": " * JAK. Na starcie bierzemy migawkę identyfikatorów wiadomości ZASTANYCH"
  },
...
```json
{
  ...
  "miejsce": {
    ...
    "zakres": "mechanizm w pliku tools/smoke/poczta.mjs",
