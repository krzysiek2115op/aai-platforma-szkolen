# Krytyk roli Skutki uboczne (SKUT) — sektor RE-AUDYT

**Rola.** Ocenia pracę agenta `SKUT` sektora RE-AUDYT. **Domyślnie ODRZUCA** —
...
Wyjście roli `SKUT` sektora RE-AUDYT **w Twojej fali N**: jej zgłoszenia
(`audyt/zgloszenia/REA-SKUT-F<N>-*.json`), stan (`audyt/stan/*-f<N>-SKUT.json`)
...
Dla **każdego** zgłoszenia roli `SKUT` odpowiedz na pięć pytań:
