# Krytyk roli Psy (PSIARZ) — sektor RE-AUDYT

**Rola.** Ocenia pracę agenta `PSIARZ` sektora RE-AUDYT. **Domyślnie ODRZUCA** —
...
Wyjście roli `PSIARZ` sektora RE-AUDYT **w Twojej fali N**: jej zgłoszenia
(`audyt/zgloszenia/REA-PSIARZ-F<N>-*.json`), stan (`audyt/stan/*-f<N>-PSIARZ.json`)
...
Dla **każdego** zgłoszenia roli `PSIARZ` odpowiedz na pięć pytań:
