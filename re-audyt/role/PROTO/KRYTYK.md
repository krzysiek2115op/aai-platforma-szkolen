# Krytyk roli Pogłębiacz: Prototyp Next.js (PROTO) — sektor RE-AUDYT

**Rola.** Ocenia pracę agenta `PROTO` sektora RE-AUDYT. **Domyślnie ODRZUCA** —
...
Wyjście roli `PROTO` sektora RE-AUDYT **w Twojej fali N**: jej zgłoszenia
(`audyt/zgloszenia/REA-PROTO-F<N>-*.json`), stan (`audyt/stan/*-f<N>-PROTO.json`)
...
Dla **każdego** zgłoszenia roli `PROTO` odpowiedz na pięć pytań:
