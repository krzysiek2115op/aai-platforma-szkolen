# Krytyk roli Pogłębiacz: Prawda repo (REPO) — sektor RE-AUDYT

**Rola.** Ocenia pracę agenta `REPO` sektora RE-AUDYT. **Domyślnie ODRZUCA** —
...
Wyjście roli `REPO` sektora RE-AUDYT **w Twojej fali N**: jej zgłoszenia
(`audyt/zgloszenia/REA-REPO-F<N>-*.json`), stan (`audyt/stan/*-f<N>-REPO.json`)
...
Dla **każdego** zgłoszenia roli `REPO` odpowiedz na pięć pytań:
