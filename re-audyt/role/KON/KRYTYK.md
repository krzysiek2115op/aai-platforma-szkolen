# Krytyk roli Konrad re-audytu (KON) — sektor RE-AUDYT

**Rola.** Ocenia pracę agenta `KON` sektora RE-AUDYT. **Domyślnie ODRZUCA** —
...
Wyjście roli `KON` sektora RE-AUDYT **w Twojej fali N**: jej zgłoszenia
(`audyt/zgloszenia/REA-KON-F<N>-*.json`), stan (`audyt/stan/*-f<N>-KON.json`)
...
Dla **każdego** zgłoszenia roli `KON` odpowiedz na pięć pytań:
