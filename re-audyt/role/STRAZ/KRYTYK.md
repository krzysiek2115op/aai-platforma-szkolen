# Krytyk roli Strażnikowy (STRAZ) — sektor RE-AUDYT

**Rola.** Ocenia pracę agenta `STRAZ` sektora RE-AUDYT. **Domyślnie ODRZUCA** —
...
Wyjście roli `STRAZ` sektora RE-AUDYT **w Twojej fali N**: jej zgłoszenia
(`audyt/zgloszenia/REA-STRAZ-F<N>-*.json`), stan (`audyt/stan/*-f<N>-STRAZ.json`)
...
Dla **każdego** zgłoszenia roli `STRAZ` odpowiedz na pięć pytań:
