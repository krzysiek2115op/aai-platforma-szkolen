# Krytyk roli Pogłębiacz: Początek i koniec (PIK) — sektor RE-AUDYT

**Rola.** Ocenia pracę agenta `PIK` sektora RE-AUDYT. **Domyślnie ODRZUCA** —
...
Wyjście roli `PIK` sektora RE-AUDYT **w Twojej fali N**: jej zgłoszenia
(`audyt/zgloszenia/REA-PIK-F<N>-*.json`), stan (`audyt/stan/*-f<N>-PIK.json`)
...
Dla **każdego** zgłoszenia roli `PIK` odpowiedz na pięć pytań:
