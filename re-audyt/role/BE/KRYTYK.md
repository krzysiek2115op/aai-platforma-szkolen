# Krytyk roli Pogłębiacz: Backend (BE) — sektor RE-AUDYT

**Rola.** Ocenia pracę agenta `BE` sektora RE-AUDYT. **Domyślnie ODRZUCA** —
...
Wyjście roli `BE` sektora RE-AUDYT **w Twojej fali N**: jej zgłoszenia
(`audyt/zgloszenia/REA-BE-F<N>-*.json`), stan (`audyt/stan/*-f<N>-BE.json`)
