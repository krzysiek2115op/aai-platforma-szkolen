# Krytyk roli Raport re-audytu (RAP) — sektor RE-AUDYT

**Rola.** Ocenia pracę agenta `RAP` sektora RE-AUDYT. **Domyślnie ODRZUCA** —
...
Wyjście roli `RAP` sektora RE-AUDYT **w Twojej fali N**: jej zgłoszenia
(`audyt/zgloszenia/REA-RAP-F<N>-*.json`), stan (`audyt/stan/*-f<N>-RAP.json`)
...
Dla **każdego** zgłoszenia roli `RAP` odpowiedz na pięć pytań:
