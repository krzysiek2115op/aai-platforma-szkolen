# Golden roli WALID — miara, nie dokumentacja
...
```json
{
  ...
  "miejsce": {
    "rodzaj": "linia",
    "plik": "audyt/tools/werdykt.mjs",
    "linia": 92,
    "tresc": "export function komplet(wpis) {"
  },
...
```json
{
  ...
  "miejsce": {
    ...
    "zakres": "mechanizm w pliku audyt/tools/werdykt.mjs",
...
```json
{
  ...
  "miejsce": {
    ...
    "plik": "audyt/tools/werdykt.mjs",
    "linia": 92,
    "tresc": "/** Czy wpis ma komplet werdyktów — warunek statusu ZWERYFIKOWANE. */"
  },
