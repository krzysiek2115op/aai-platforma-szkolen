# Krytyk roli Pogłębiacz: Prywatność i zgodność (PRIV) — sektor RE-AUDYT

**Rola.** Ocenia pracę agenta `PRIV` sektora RE-AUDYT. **Domyślnie ODRZUCA** —
...
Wyjście roli `PRIV` sektora RE-AUDYT **w Twojej fali N**: jej zgłoszenia
(`audyt/zgloszenia/REA-PRIV-F<N>-*.json`), stan (`audyt/stan/*-f<N>-PRIV.json`)
...
Dla **każdego** zgłoszenia roli `PRIV` odpowiedz na pięć pytań:
