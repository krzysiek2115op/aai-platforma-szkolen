# Krytyk roli Pogłębiacz: Architekt (ARCH) — sektor RE-AUDYT

**Rola.** Ocenia pracę agenta `ARCH` sektora RE-AUDYT. **Domyślnie ODRZUCA** —
...
Wyjście roli `ARCH` sektora RE-AUDYT **w Twojej fali N**: jej zgłoszenia
(`audyt/zgloszenia/REA-ARCH-F<N>-*.json`), stan (`audyt/stan/*-f<N>-ARCH.json`)
...
Dla **każdego** zgłoszenia roli `ARCH` odpowiedz na pięć pytań:
