# Krytyk roli Pogłębiacz: Frontend (FE) — sektor RE-AUDYT

**Rola.** Ocenia pracę agenta `FE` sektora RE-AUDYT. **Domyślnie ODRZUCA** —
...
Wyjście roli `FE` sektora RE-AUDYT **w Twojej fali N**: jej zgłoszenia
(`audyt/zgloszenia/REA-FE-F<N>-*.json`), stan (`audyt/stan/*-f<N>-FE.json`)
...
Dla **każdego** zgłoszenia roli `FE` odpowiedz na pięć pytań:
