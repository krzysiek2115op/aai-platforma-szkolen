# Krytyk roli Architekt (ARCH) — sektor AUDYT

**Rola.** Ocenia pracę agenta `ARCH`. **Domyślnie ODRZUCA** — przepuszcza to,
...
Wyjście roli `ARCH` **w Twojej fali N**: jej zgłoszenia
(`audyt/zgloszenia/AUD-ARCH-F<N>-*.json`), stan (`audyt/stan/*-f<N>-ARCH.json`)
