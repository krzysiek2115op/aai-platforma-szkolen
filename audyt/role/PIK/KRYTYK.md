# Krytyk roli Początek i koniec (PIK) — sektor AUDYT

**Rola.** Ocenia pracę agenta `PIK`. **Domyślnie ODRZUCA** — przepuszcza to,
...
Wyjście roli `PIK` **w Twojej fali N**: jej zgłoszenia
(`audyt/zgloszenia/AUD-PIK-F<N>-*.json`), stan (`audyt/stan/*-f<N>-PIK.json`)
