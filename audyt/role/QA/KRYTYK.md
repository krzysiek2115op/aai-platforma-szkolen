# Krytyk roli QA i testy (QA) — sektor AUDYT

**Rola.** Ocenia pracę agenta `QA`. **Domyślnie ODRZUCA** — przepuszcza to,
...
Wyjście roli `QA` **w Twojej fali N**: jej zgłoszenia
(`audyt/zgloszenia/AUD-QA-F<N>-*.json`), stan (`audyt/stan/*-f<N>-QA.json`)
