# Golden roli PROTO — miara, nie dokumentacja
...
istnieją w `app/szkolenia/page.serwer.tsx` i są tam ZDROWE — golden nie zgłasza
...
```json
{
  ...
  "dzial": "PROTO",
  "pozycja": "PROTO-01",
  "stwierdzenie": "Trasa katalogu deklaruje tryb renderowania wyrażeniem zamiast literałem, a kompilator Next parsuje tę wartość statycznie, więc tryb rozstrzyga się inaczej niż zakłada kod.",
  "miejsce": {
    "rodzaj": "linia",
    "plik": "app/szkolenia/page.serwer.tsx",
    "linia": 20,
    "tresc": "export const dynamic = \"force-dynamic\";"
  },
  "dowod": "Linia 20 podaje literał, a dokumentacja Next w docs/dokumentacja-techniczna wymaga literału dla dynamic i generateStaticParams — próba z wyrażeniem nie kompiluje się.",
  "klasyfikacja": "przyklad-dydaktyczny",
  "wplyw": "Katalog wchodzi do eksportu statycznego z danymi z czasu builda i klient widzi nieaktualną listę kursów."
}
```
...
```json
{
  ...
  "dzial": "PROTO",
  "pozycja": "PROTO-02",
  "stwierdzenie": "Tryb podglądu statycznego rozstrzyga się w dwóch miejscach, więc zmiana w jednym z nich nie przenosi się na drugie.",
  "miejsce": {
    "rodzaj": "mechanizm",
    "plik": "app/szkolenia/page.serwer.tsx",
    "zakres": "app/szkolenia/page.serwer.tsx, deklaracje trybu",
    "mechanizm": "brak jednego źródła prawdy o trybie podglądu — rozstrzygnięcie powinno siedzieć wyłącznie w lib/podglad.ts, a nie powtarzać się w trasie"
  },
  "dowod": "Poza lib/podglad.ts istnieje drugie miejsce decydujące o trybie, a pageExtensions rozdziela pliki właśnie po to, by było jedno.",
  "klasyfikacja": "przyklad-dydaktyczny",
  "wplyw": "Podgląd publiczny może wypuścić trasę prywatną albo pominąć publiczną, bez żadnego objawu w buildzie."
}
```
...
```json
{
  ...
  "dzial": "PROTO",
  "pozycja": "PROTO-01",
  "stwierdzenie": "Trasa katalogu deklaruje tryb force-static, więc lista kursów zamarza na stanie z czasu budowania.",
  "miejsce": {
    "rodzaj": "linia",
    "plik": "app/szkolenia/page.serwer.tsx",
    "linia": 20,
    "tresc": "export const dynamic = \"force-static\";"
  },
