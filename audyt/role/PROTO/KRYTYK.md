# Krytyk roli Prototyp Next.js (PROTO) — sektor AUDYT

**Rola.** Ocenia pracę agenta `PROTO`. **Domyślnie ODRZUCA** — przepuszcza to,
...
Wyjście roli `PROTO` **w Twojej fali N**: jej zgłoszenia
(`audyt/zgloszenia/AUD-PROTO-F<N>-*.json`), stan (`audyt/stan/*-f<N>-PROTO.json`)
