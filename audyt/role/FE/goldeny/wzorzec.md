# Golden roli FE — miara, nie dokumentacja
...
istnieją w `wordpress/wtyczki/aai-sklep/assets/panel.js` i są tam ZDROWE — golden nie zgłasza
...
```json
{
  ...
  "dzial": "FE",
  "pozycja": "FE-01",
  "stwierdzenie": "Lista granic zakresu kolektora nie obejmuje wiersza lekcji, więc pola z sąsiednich rekordów wpadają do jednego i zapis nadaje modułowi tytuł jego ostatniej lekcji.",
  "miejsce": {
    "rodzaj": "linia",
    "plik": "wordpress/wtyczki/aai-sklep/assets/panel.js",
    "linia": 58,
    "tresc": "var GRANICE_ZAKRESU = ["
  },
  "dowod": "Lista z linii 58 ma cztery znaczniki, a panel rysuje pięć rodzajów rekordów — porównanie obu list pokazuje, którego brakuje.",
  "klasyfikacja": "przyklad-dydaktyczny",
  "wplyw": "Właściciel zapisuje kurs bez żadnej zmiany i traci tytuły wszystkich modułów, przy komunikacie o sukcesie."
}
```
...
```json
{
  ...
  "dzial": "FE",
  "pozycja": "FE-02",
  "stwierdzenie": "Kolektor panelu nie zna granicy rekordu materiału, więc jego pola są zbierane razem z polami sąsiedniego rekordu.",
  "miejsce": {
    "rodzaj": "mechanizm",
    "plik": "wordpress/wtyczki/aai-sklep/assets/panel.js",
    "zakres": "zbierz() w assets/panel.js",
    "mechanizm": "brak granicy zakresu dla rekordu materiału — powinna stać w tej samej liście co granice modułu i lekcji"
  },
  "dowod": "Lista GRANICE_ZAKRESU wymienia rekordy modułu i lekcji, a panel rysuje także rekord materiału.",
  "klasyfikacja": "przyklad-dydaktyczny",
  "wplyw": "Zapis miesza materiały między lekcjami, a klient dostaje odnośnik do cudzego pliku."
}
```
...
```json
{
  ...
  "dzial": "FE",
  "pozycja": "FE-01",
  "stwierdzenie": "Kolektor panelu deklaruje listę granic zakresu przez const, którego przeglądarka klienta nie obsługuje.",
  "miejsce": {
    "rodzaj": "linia",
    "plik": "wordpress/wtyczki/aai-sklep/assets/panel.js",
    "linia": 58,
    "tresc": "const GRANICE_ZAKRESU = ["
  },
