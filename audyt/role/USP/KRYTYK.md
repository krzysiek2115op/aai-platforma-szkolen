# Krytyk roli Usprawnienia audytowe (USP) — sektor AUDYT

**Rola.** Ocenia pracę agenta `USP`. **Domyślnie ODRZUCA** — przepuszcza to,
...
Wyjście roli `USP` **w Twojej fali N**: jej zgłoszenia
(`audyt/zgloszenia/AUD-USP-F<N>-*.json`), stan (`audyt/stan/*-f<N>-USP.json`)
