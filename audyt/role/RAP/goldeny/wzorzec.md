# Golden roli RAP — miara, nie dokumentacja
...
istnieją w `audyt/PLAN-BUDOWY.md` i są tam ZDROWE — golden nie zgłasza
...
```json
{
  ...
  "dzial": "RAP",
  "pozycja": "RAP-01",
  "stwierdzenie": "Raport nie zawiera tabeli wartości początku i końca, choć rozstrzygnięcie właściciela wymaga, żeby trafiały do raportu obu sektorów.",
  "miejsce": {
    "rodzaj": "linia",
    "plik": "audyt/PLAN-BUDOWY.md",
    "linia": 104,
    "tresc": "| W1 | Wartości obu sektorów trafiają do **raportu** |"
  },
  "dowod": "Wiersz z linii 104 zapisuje ten wymóg wprost, a przegląd raportu nie zwraca sekcji z obiema migawkami.",
  "klasyfikacja": "przyklad-dydaktyczny",
  "wplyw": "Czytelnik raportu nie ma dowodu na to, że sektor niczego w projekcie nie zmienił."
}
```
...
```json
{
  ...
  "dzial": "RAP",
  "pozycja": "RAP-02",
  "stwierdzenie": "Raport nie nazywa obszarów wyłączonych z audytu ani pozycji niedomkniętych po suficie rund, więc czytelnik zakłada pokrycie, którego nie było.",
  "miejsce": {
    "rodzaj": "mechanizm",
    "plik": "audyt/PLAN-BUDOWY.md",
    "zakres": "raport końcowy, sekcja granic",
    "mechanizm": "brak sekcji nazywającej, czego audyt nie sprawdził — powinna stać obok listy znalezisk, bo bez niej raport czyta się jak pokrycie pełne"
  },
  "dowod": "Rozstrzygnięcie D4 wyklucza kursy z zakresu, a raport nie wymienia żadnego wykluczenia.",
  "klasyfikacja": "przyklad-dydaktyczny",
  "wplyw": "Właściciel podejmuje decyzje na podstawie raportu, który przemilcza własne granice."
}
```
...
```json
{
  ...
  "dzial": "RAP",
  "pozycja": "RAP-01",
  "stwierdzenie": "Wiersz rozstrzygnięcia W1 jest zapisany bez polskich znaków i bez wyróżnienia, więc odsyłacze do niego nie działają.",
  "miejsce": {
    "rodzaj": "linia",
    "plik": "audyt/PLAN-BUDOWY.md",
    "linia": 104,
    "tresc": "| W1 | Wartosci obu sektorow trafiaja do raportu |"
  },
