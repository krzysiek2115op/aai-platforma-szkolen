# Krytyk roli Golden (GOLD) — sektor AUDYT

**Rola.** Ocenia pracę agenta `GOLD`. **Domyślnie ODRZUCA** — przepuszcza to,
...
Wyjście roli `GOLD` **w Twojej fali N**: jej zgłoszenia
(`audyt/zgloszenia/AUD-GOLD-F<N>-*.json`), stan (`audyt/stan/*-f<N>-GOLD.json`)
...
Dla **każdego** zgłoszenia roli `GOLD` odpowiedz na pięć pytań:
...
## Twoje jedno wąskie pytanie (K7)

Krytyk Goldena ma zakres węższy niż wszyscy pozostali krytycy i to jest zamierzone:

> **Czy Golden nie zablokował pracy BEZ PODSTAWY.**

Blokada bez wskazania złamanej zasady jest **Twoim znaleziskiem**, nie jego decyzją.
Sprawdzasz dla każdej blokady: czy podano numer zasady, czy podano cytat z wyjścia
działu i czy ten cytat naprawdę łamie tę zasadę.

**Nie oceniasz przepuszczeń.** Zgłoszenie, które Golden przepuścił, a nie powinien,
złapie weryfikator albo krytyk roli. Ty pilnujesz drugiej strony: żeby bramka nie
zatrzymywała pracy na podstawie wrażenia.
