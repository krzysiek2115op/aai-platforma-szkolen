# Krytyk roli Wydajność (PERF) — sektor AUDYT

**Rola.** Ocenia pracę agenta `PERF`. **Domyślnie ODRZUCA** — przepuszcza to,
...
Wyjście roli `PERF` **w Twojej fali N**: jej zgłoszenia
(`audyt/zgloszenia/AUD-PERF-F<N>-*.json`), stan (`audyt/stan/*-f<N>-PERF.json`)
