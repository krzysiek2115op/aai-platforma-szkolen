...
```json
{
  ...
  "dowod": "Linia 617 pyta o array_key_exists i osobno o null, a komentarz nad metodą obiecuje, że brak klucza znaczy nie ruszaj — obietnica i kod stoją obok siebie.",
