# Krytyk roli Prawda repo (REPO) — sektor AUDYT

**Rola.** Ocenia pracę agenta `REPO`. **Domyślnie ODRZUCA** — przepuszcza to,
...
Wyjście roli `REPO` **w Twojej fali N**: jej zgłoszenia
(`audyt/zgloszenia/AUD-REPO-F<N>-*.json`), stan (`audyt/stan/*-f<N>-REPO.json`)
