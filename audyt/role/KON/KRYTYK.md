# Krytyk roli Agent Konrad (KON) — sektor AUDYT

**Rola.** Ocenia pracę agenta `KON`. **Domyślnie ODRZUCA** — przepuszcza to,
...
Wyjście roli `KON` **w Twojej fali N**: jej zgłoszenia
(`audyt/zgloszenia/AUD-KON-F<N>-*.json`), stan (`audyt/stan/*-f<N>-KON.json`)
