...
|---|---|
| **Wersja** | **0.37.0** |
| **Etap** | Działy 1–7 Pluginu 1 gotowe, **B1–B7 zaliczone** (B7: właściciel, 2026-08-25). [Plan domknięcia](docs/plugin-1/PLAN-FINAL-PLUGINU-1.md): kroki 1–3 zamknięte (0.25.0, 0.29.0, 0.32.0 — oba kursy kompletne: 41/41 i 32/32 lekcji, 148 zrzutów); przegląd agent + krytyk wykonany (0.36.0), sześć decyzji po nim wykonanych (0.37.0). Zostaje **merge na `main`** i etap **WordPressa** |
...
> 103 sposoby (mutacje + kontrprzykłady „strażnik ma milczeć”)
