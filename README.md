...
|---|---|
| **Wersja** | **0.61.0** |
| **Etap** | Prototyp UKOŃCZONY i scalony na `main` (0.37.0, B1–B7 zaliczone). **Etap WordPressa zamknięty kodem**: trzy wtyczki skończone, test całości i release zabezpieczeniowy wydane ([decyzje i plan](docs/ETAP-WP.md)). Trwają **trzy ostatnie kroki** ([plan](docs/PLAN-SEO-HIGIENA-AUDYT.md)) — szczegóły pod tabelą |
| **Wtyczki WordPressa** | `aai-sklep` — W1–W6, `v0.45.0` · `aai-platnosci` — P0–P6, `v0.53.0` · `aai-monitor` — T0–T4, `v0.58.0`. Każda z osobnym testem ręcznym właściciela, zaliczonym |
